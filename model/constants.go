...
enum PrimitiveTableEnum {
  DrawArrays ArrayTable= 50
  DrawArraysLength ArrayTable= 51
  DrawElementsUByte ArrayTable= 52
  DrawElementsUShort ArrayTable= 53
  DrawElementsUInt ArrayTable= 54

  GL_POINTS ArrayTable= 0x0000
  GL_LINES ArrayTable= 0x0001
  GL_LINE_STRIP ArrayTable= 0x0003
  GL_LINE_LOOP ArrayTable= 0x0002
  GL_TRIANGLES ArrayTable= 0x0004
  GL_TRIANGLE_STRIP ArrayTable= 0x0005
  GL_TRIANGLE_FAN ArrayTable= 0x0006
  GL_QUADS ArrayTable= 0x0007
  GL_QUAD_STRIP ArrayTable= 0x0008
  GL_POLYGON ArrayTable= 0x0009

  GL_LINES_ADJACENCY ArrayTable= 0x000A
  GL_LINES_ADJACENCY_EXT ArrayTable= 0x000A
  GL_LINE_STRIP_ADJACENCY_EXT ArrayTable= 0x000B
  GL_LINE_STRIP_ADJACENCY ArrayTable= 0x000B
  GL_TRIANGLES_ADJACENCY ArrayTable= 0x000C
  GL_TRIANGLES_ADJACENCY_EXT ArrayTable= 0x000C
  GL_TRIANGLE_STRIP_ADJACENCY ArrayTable= 0x000D
  GL_TRIANGLE_STRIP_ADJACENCY_EXT ArrayTable= 0x000D

	GL_PATCHES ArrayTable= 0x000E
