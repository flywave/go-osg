...
func readAmbient(is *osg.OsgIstream, pro interface{}) {
...
func writeAmbient(os *osg.OsgOstream, pro interface{}) {
	mt := pro.(*model.Material)
...
func readDiffuse(is *osg.OsgIstream, pro interface{}) {
	mt := pro.(*model.Material)
	frontAndBack := false
	is.Read(&frontAndBack)
	is.PROPERTY.Name = "Front"
...
func writeDiffuse(os *osg.OsgOstream, pro interface{}) {
	mt := pro.(*model.Material)
...
func readSpecular(is *osg.OsgIstream, pro interface{}) {
	mt := pro.(*model.Material)
	frontAndBack := false
	is.Read(&frontAndBack)
	is.PROPERTY.Name = "Front"
...
func writeSpecular(os *osg.OsgOstream, pro interface{}) {
	mt := pro.(*model.Material)
...
func readEmission(is *osg.OsgIstream, pro interface{}) {
	mt := pro.(*model.Material)
	frontAndBack := false
	is.Read(&frontAndBack)
	is.PROPERTY.Name = "Front"
...
func writeEmission(os *osg.OsgOstream, pro interface{}) {
	mt := pro.(*model.Material)
...
func readShininess(is *osg.OsgIstream, pro interface{}) {
	mt := pro.(*model.Material)
	frontAndBack := false
	is.Read(&frontAndBack)
	is.PROPERTY.Name = "Front"
...
func writeShininess(os *osg.OsgOstream, pro interface{}) {
	mt := pro.(*model.Material)
...
func init() {
	...
	wrap := osg.NewObjectWrapper("Material", fn, "osg::Object osg::StateAttribute osg::Material")
	ser1 := osg.NewEnumSerializer("ColorMode", getColorMode, setColorMode)
	...
	ser2 := osg.NewUserSerializer("Ambient", checkAmbient, readAmbient, writeAmbient)
	ser3 := osg.NewUserSerializer("Diffuse", checkDiffuse, readDiffuse, writeDiffuse)
	ser4 := osg.NewUserSerializer("Specular", checkSpecular, readSpecular, writeSpecular)
	ser5 := osg.NewUserSerializer("Emission", checkEmission, readEmission, writeEmission)
	ser6 := osg.NewUserSerializer("Shininess", checkShininess, readShininess, writeShininess)
