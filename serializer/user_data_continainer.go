...
func readUDCUserData(is *osg.OsgIstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
...
func writeUDCUserData(os *osg.OsgOstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
...
func readUDCDescriptions(is *osg.OsgIstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
	size := is.ReadSize()
	is.Read(is.BEGINBRACKET)
	for i := 0; i < size; i++ {
...
func writeUDCDescriptions(os *osg.OsgOstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
...
func readUDCUserObjects(is *osg.OsgIstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
	size := is.ReadSize()
	is.Read(is.BEGINBRACKET)
	for i := 0; i < size; i++ {
...
func writeUDCUserObjects(os *osg.OsgOstream, obj interface{}) {
	udc := obj.(*model.UserDataContainer)
...
func init() {
	...
	wrap := osg.NewObjectWrapper("UserDataContainer", fn, "osg::UserDataContainer")
	...
	ser3 := osg.NewUserSerializer("UDCUserData", checkUDCUserData, readUDCUserData, writeUDCUserData)
	ser4 := osg.NewUserSerializer("UDCDescriptions", checkUDCDescriptions, readUDCDescriptions, writeUDCDescriptions)
	ser5 := osg.NewUserSerializer("UDCUserObjects", checkUDCUserObjects, readUDCUserObjects, writeUDCUserObjects)
